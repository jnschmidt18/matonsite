...
<body>
  <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="http://www.mattoonsrevenge.com" class="brand-logo">Bag o' Goldfish Studios</a>
      <ul class="right hide-on-med-and-down">
        <li><a href="http://www.itexmachina.com">by IT ex Machina</a></li>
      </ul>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text ">Mattoon's Revenge</h1>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Exciting RPG Action</h5>

            <p class="dark">Kill all the bad guys and don't get killed. It's pretty simple.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Singleplayer Only</h5>

            <p class="dark">Singleplayer action provides an environment in which you can brutally murder your enemies without criticism from angry 12 year olds cyberbullying you for your inability.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">You Can't Change the Controls</h5>

            <p class="dark">But you dont have to. If you can't use WASD you probably suck anyways.</p>
          </div>
        </div>
      </div>
  ...
  <div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h5 class="header center black-text s12 dark">Mattoon's Revenge is the first game published by Bag o' Goldfish Studios. Follow Mr. Mattoon as he goes on an epic quest to take back the kingdom from the grasp of an evil dictator.</h5>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
		...
		<div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="https://github.com/tei06398">Seth's Github</a></li>
            <li><a class="white-text" href="https://github.com/TnF711">Trey's Github</a></li>
            <li><a class="white-text" href="https://github.com/jnschmidt18">Josiah's Github</a></li>
            <li><a class="white-text" href="https://github.com/BagOGoldfish">Company Github</a></li>
          </ul>
        </div>
        <div class="col l3 s12">
